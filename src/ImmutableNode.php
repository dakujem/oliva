...
/**
 * TODO
 * The idea was to have a data node that prevents outside changes to the data.
 * However, we might also want a node implementation that would prevent changing the tree structure,
 * and the combination of both. That may become messy.
 * Then, do we keep the DataNodeContract as-is, or do we split those two methods it currently declares?
 *
 * TODO + refactor the internals
 *
 * @author Andrej Rypak <xrypak@gmail.com>
 */
class ImmutableNode implements TreeNodeContract, DataNodeContract, MovableNodeContract, IteratorAggregate, JsonSerializable
{
    /**
     * Create a data node.
     *
    ...
    {
        // TODO we may want to completely remove this method, because it breaks the DataNodeContract contract.
        throw new LogicException('TODO: Changing the node data is not supported.');
    }
